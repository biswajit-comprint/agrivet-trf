...
<!-- Page Heading -->
<h1 class="h5 mb-2 text-gray-800">Edit report</h1>
        ...
        <div class="row">
            <div class="col-12">
                <div class="flex flex-row align-content-center align-items-center">
                    ...
                    <div class="flex-fill text-center" style="width: 33.33%"><h4>Report</h4></div>
...
<div class="col-12 mb-5">
    <div class="flex flex-row justify-content-end">
        <div>
            <a href="./pdf_report.php?action=pdf_report&trfId=5236552&reportId=4525" type="button" class="btn btn-danger btn-icon-split mx-1">
                <span class="icon text-white-50">
                    <i class="fas fa-file-pdf"></i>
                </span>
                <span class="text">PDF</span>
            </a>
            <a href="./view_report.php?action=view_report&trfId=5236552&reportId=4525" type="button" class="btn btn-primary btn-icon-split mx-1">
                <span class="icon text-white-50">
                    <i class="fas fa-file-pdf"></i>
                </span>
                <span class="text">View</span>
            </a>
            <button type="button" class="btn btn-primary btn-icon-split mx-1">
                <span class="icon text-white-50">
