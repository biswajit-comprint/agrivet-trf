        ...
        <form action="/action_page.php">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h5 class="display-5 font-weight-bold"><i class="fas fa-file-invoice mr-2"></i>Billing Details</h5>
                </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h5 class="display-5 font-weight-bold"><i class="fas fa-address-card mr-2"></i>Reporting address</h5>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <label for="company_name" class="form-label">Company name:</label>
                    <input type="text" class="form-control" id="company_name" placeholder="Enter Company name" name="company_name">
            ...
            <div class="row mt-5">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h5 class="display-5 font-weight-bold"><i class="fas fa-money-check mr-2"></i> Payment details</h5>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive table-responsive-lg table-responsive-md table-responsive-sm">
            <table class="table table-sm table-bordered" width="100%" cellspacing="0">
                ...
                <tbody id="create_trf_item_dynamic_fields">
                    <tr>
                        <td>1</td>
                        <td>
        ...
        <div class="row">
            <div class="col-6">
                <button href="#" class="btn btn-sm btn-primary btn-icon-split" id="btn_create_trf_item_dynamic_fields">
