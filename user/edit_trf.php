    ...
    <div class="card-body">
        ...
        <div class="table-responsive table-responsive-lg table-responsive-md table-responsive-sm">
            <table class="table table-sm table-bordered" width="100%" cellspacing="0">
                ...
                <tbody id="edit_trf_item_dynamic_fields">
                    <tr>
                        <td>1</td>
                        <td>
        ...
        <div class="row">
            <div class="col-6">
                <button class="btn btn-sm btn-primary btn-icon-split" id="btn_edit_trf_item_dynamic_fields">
                    <span class="icon text-white-50">
...
<div class="row mt-4 mb-3">
    <div class="col-12 text-right">
        <a href="./view_trf.php?action=view_trf&uId=4525&trfId=5236552" class="btn btn-primary btn-icon-split">
            <span class="icon text-white-50">
        ...
        <a href="./pdf_trf.php?action=pdf_trf&uId=4525&trfId=5236552" class="btn btn-danger btn-icon-split">
            <span class="icon text-white-50">
