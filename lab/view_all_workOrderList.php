...
<!-- Page Heading -->
<h1 class="h5 mb-2 text-gray-800">Work order list</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Work order list Details</h6>
    </div>
    <div class="card-body">
                        ...
                        <td class="text-center">
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="./create_report.php?action=create_report&trfId=4523&woId=4252">Create report</a>
                                    <a class="dropdown-item" href="#?action=view_workOrder&trfId=4523&woId=4252">View work order</a>
                                </div>
                            </div>
                        </td>
                    </tr>
