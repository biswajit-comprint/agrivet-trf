...
<div class="col-12 mb-5">
    <div class="flex flex-row justify-content-end">
        <div>
            ...
            <a href="./pdf_report.php?action=pdf_report&rtId=45256" class="btn btn-danger btn-icon-split mx-1">
                <span class="icon text-white-50">
                    <i class="fas fa-file-pdf"></i>
                </span>
                <span class="text">PDF</span>
            </a>
            <a href="./view_report.php?action=view_report&rtId=45256" class="btn btn-primary btn-icon-split mx-1">
                <span class="icon text-white-50">
                    <i class="fas fa-edit"></i>
                </span>
